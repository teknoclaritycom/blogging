<x-slot name="header">
    <h2 class="text-center">Tambah Decision Maker</h2>
</x-slot>
<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg px-4 py-4">
            ...
            <span>INGAT HANYA 3 DECISIONER DAN HARUS 3 !!!</span>
            <button wire:click="create()"
                class="my-4 inline-flex justify-center w-full rounded-md border border-transparent px-4 py-2 bg-red-600 text-base font-bold text-white shadow-sm hover:bg-red-700">
                Tambah Decision Maker
            </button>
            @endif
            <span>DMs yang di Gunakan pada Penelitian ini Bersifat Statis hanya 3 DMs, Hanya Perubahan yang di Perbolehkan</span><br>
            @if($isModalOpen)
            @include('livewire.createdc')
            @endif
            <table class="table-fixed w-full">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="border px-4 py-2">{{ $dcs->kode }}</td>
